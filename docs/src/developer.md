...
If you are planning significant changes, open an [issue](https://github.com/ohno/MyPkg73.jl/issues) first. The [ColPrac](https://github.com/SciML/ColPrac) guidelines are recommended. For Julia package development basics, see:
...
1. Fork the [repository](https://github.com/ohno/MyPkg73.jl) on GitHub.
2. Clone the forked repository. Replace `xxxxxx` with your GitHub username.
   ```sh
   git clone https://github.com/xxxxxx/MyPkg73.jl.git
   cd MyPkg73.jl
   ```
...
2. Start an interactive session with [Revise.jl](https://github.com/timholy/Revise.jl).
   ```sh
   julia --startup-file=no -i -e 'using Revise; import Pkg; Pkg.activate("."); using MyPkg73'
   ```
...
- the version in [Project.toml](https://github.com/ohno/MyPkg73.jl/blob/main/Project.toml)
- the version, year, and month in [CITATION.bib](https://github.com/ohno/MyPkg73.jl/blob/main/CITATION.bib)
